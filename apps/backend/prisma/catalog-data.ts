...
export const CATALOG_DATA: CatalogItem[] = [
  ...
  { name: 'Mild Steel Round Bar 12mm', type: ResourceType.MATERIAL, unit: 'kg', rate: 68, gstRate: 18, hsn: '7213', category: 'Steel' },
  { name: 'Mild Steel Round Bar 16mm', type: ResourceType.MATERIAL, unit: 'kg', rate: 68, gstRate: 18, hsn: '7213', category: 'Steel' },
  { name: 'Mild Steel Round Bar 20mm', type: ResourceType.MATERIAL, unit: 'kg', rate: 68, gstRate: 18, hsn: '7213', category: 'Steel' },
  ...
  { name: 'Rebar Coupler 20mm', type: ResourceType.MATERIAL, unit: 'piece', rate: 180, gstRate: 18, hsn: '7308', category: 'Steel' },
  { name: 'Rebar Coupler 25mm', type: ResourceType.MATERIAL, unit: 'piece', rate: 220, gstRate: 18, hsn: '7308', category: 'Steel' },
  { name: 'MS Flat 25x3mm', type: ResourceType.MATERIAL, unit: 'kg', rate: 72, gstRate: 18, hsn: '7213', category: 'Steel' },
  { name: 'MS Flat 40x6mm', type: ResourceType.MATERIAL, unit: 'kg', rate: 72, gstRate: 18, hsn: '7213', category: 'Steel' },
  ...
  { name: 'Stainless Steel Sheet 304 1mm', type: ResourceType.MATERIAL, unit: 'sqm', rate: 850, gstRate: 18, hsn: '7219', category: 'Steel' },
  ...
  { name: 'Quarry Dust', type: ResourceType.MATERIAL, unit: 'cum', rate: 1100, gstRate: 5, hsn: '2521', category: 'Aggregates' },
  ...
  // 4. BRICKS, BLOCKS & MASONRY
  // ════════════════════════════════════════════════════════════════
  { name: 'Red Clay Brick Class A 230x115x75', type: ResourceType.MATERIAL, unit: 'piece', rate: 9, gstRate: 5, hsn: '6901', category: 'Bricks' },
  { name: 'Red Clay Brick Class B 230x115x75', type: ResourceType.MATERIAL, unit: 'piece', rate: 8, gstRate: 5, hsn: '6901', category: 'Bricks' },
  ...
  { name: 'Wire Cut Brick', type: ResourceType.MATERIAL, unit: 'piece', rate: 12, gstRate: 5, hsn: '6901', category: 'Bricks' },
  { name: 'Fire Brick', type: ResourceType.MATERIAL, unit: 'piece', rate: 65, gstRate: 5, hsn: '6902', category: 'Bricks' },
  { name: 'Glazed Brick', type: ResourceType.MATERIAL, unit: 'piece', rate: 25, gstRate: 5, hsn: '6901', category: 'Bricks' },
  { name: 'Designer Brick', type: ResourceType.MATERIAL, unit: 'piece', rate: 22, gstRate: 5, hsn: '6901', category: 'Bricks' },
  ...
  { name: 'MDF Board 18mm', type: ResourceType.MATERIAL, unit: 'sqft', rate: 38, gstRate: 18, hsn: '4412', category: 'Timber' },
  { name: 'Particle Board 18mm', type: ResourceType.MATERIAL, unit: 'sqft', rate: 28, gstRate: 18, hsn: '4412', category: 'Timber' },
  ...
  { name: 'Kota Stone 25mm', type: ResourceType.MATERIAL, unit: 'sqft', rate: 65, gstRate: 18, hsn: '2515', category: 'Flooring' },
  ...
  { name: 'Vinyl Flooring 2mm', type: ResourceType.MATERIAL, unit: 'sqft', rate: 65, gstRate: 18, hsn: '3904', category: 'Flooring' },
  ...
  { name: 'Engineered Wood Flooring 12mm', type: ResourceType.MATERIAL, unit: 'sqft', rate: 180, gstRate: 18, hsn: '4418', category: 'Flooring' },
  { name: 'Terrazzo Tile 400x400', type: ResourceType.MATERIAL, unit: 'piece', rate: 120, gstRate: 18, hsn: '6907', category: 'Flooring' },
  ...
  { name: 'Quartz Surface Slab', type: ResourceType.MATERIAL, unit: 'sqft', rate: 320, gstRate: 18, hsn: '6810', category: 'Flooring' },
  ...
  { name: 'Cement Paint', type: ResourceType.MATERIAL, unit: 'kg', rate: 45, gstRate: 18, hsn: '3214', category: 'Paints' },
  ...
  { name: 'Laminated Glass 6.38mm', type: ResourceType.MATERIAL, unit: 'sqft', rate: 165, gstRate: 18, hsn: '7003', category: 'Doors' },
  ...
  { name: 'CP Brass Faucet (Mixer)', type: ResourceType.MATERIAL, unit: 'piece', rate: 1200, gstRate: 18, hsn: '7418', category: 'Plumbing' },
  { name: 'CP Brass Faucet (Pillar Cock)', type: ResourceType.MATERIAL, unit: 'piece', rate: 650, gstRate: 18, hsn: '7418', category: 'Plumbing' },
  { name: 'CP Brass Faucet (Angle Valve)', type: ResourceType.MATERIAL, unit: 'piece', rate: 380, gstRate: 18, hsn: '7418', category: 'Plumbing' },
  { name: 'Wall Mixer 3-in-1', type: ResourceType.MATERIAL, unit: 'piece', rate: 1800, gstRate: 18, hsn: '7418', category: 'Plumbing' },
  { name: 'Shower Head (Overhead) CP', type: ResourceType.MATERIAL, unit: 'piece', rate: 850, gstRate: 18, hsn: '7418', category: 'Plumbing' },
  ...
  { name: 'CP Flush Cistern (Half/Full)', type: ResourceType.MATERIAL, unit: 'piece', rate: 1800, gstRate: 18, hsn: '7418', category: 'Plumbing' },
  { name: 'CP Brass Bib Tap', type: ResourceType.MATERIAL, unit: 'piece', rate: 280, gstRate: 18, hsn: '7418', category: 'Plumbing' },
  { name: 'CP Brass Health Faucet Set', type: ResourceType.MATERIAL, unit: 'set', rate: 950, gstRate: 18, hsn: '7418', category: 'Plumbing' },
  ...
  { name: 'Fire Hose 63mm x 15m Canvas', type: ResourceType.MATERIAL, unit: 'piece', rate: 2800, gstRate: 18, hsn: '5904', category: 'Fire Safety' },
  ...
  { name: 'Jute Bag (Hessian)', type: ResourceType.MATERIAL, unit: 'piece', rate: 18, gstRate: 5, hsn: '5310', category: 'Consumables' },
  { name: 'Curing Mats (Hessian)', type: ResourceType.MATERIAL, unit: 'sqm', rate: 35, gstRate: 5, hsn: '5310', category: 'Consumables' },
  ...
  { name: 'Sand Paper 80 Grit', type: ResourceType.MATERIAL, unit: 'sheet', rate: 12, gstRate: 18, hsn: '6814', category: 'Consumables' },
  ...
  { name: 'Thinner', type: ResourceType.MATERIAL, unit: 'litre', rate: 85, gstRate: 18, hsn: '2710', category: 'Consumables' },
  ...
  // ════════════════════════════════════════════════════════════════
  { name: 'Canvas Drop Cloth 12x9 ft', type: ResourceType.MATERIAL, unit: 'nos', rate: 280, gstRate: 5, hsn: '5902', category: 'Tools & Consumables' },
  ...
  { name: 'Acoustic Underlay 5mm (Floor)', type: ResourceType.MATERIAL, unit: 'sqm', rate: 280, gstRate: 18, hsn: '4017', category: 'Acoustic' },
  ...
  { name: 'Door Viewer (Wide Angle) 14mm', type: ResourceType.MATERIAL, unit: 'nos', rate: 180, gstRate: 18, hsn: '9001', category: 'Doors' },
