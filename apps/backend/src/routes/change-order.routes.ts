...
changeOrderRouter.get(
  ...
  requireRole(Role.OWNER, Role.PM, Role.DPM),
  validate({ params: changeOrderIdParamsSchema }),
  asyncHandler(changeOrderController.listEligibleBoq),
);
changeOrderRouter.post(
  ...
  asyncHandler(changeOrderController.addBoqLines),
);
...
changeOrderRouter.put(
  ...
  asyncHandler(changeOrderController.updateLine),
);
...
changeOrderRouter.get(
  ...
  validate({ params: changeOrderIdParamsSchema }),
  asyncHandler(changeOrderController.impact),
);
...
changeOrderRouter.get(
  '/:id/scope-summary',
  validate({ params: projectIdParams }),
  asyncHandler(changeOrderController.scopeSummary),
);
