/**
 * BuildFlow Assistant — chat screen.
 * WhatsApp-style chat with amber user bubbles, white bot bubbles, typing indicator.
 */
...
export default function ChatScreen() {
  ...
  const { data: messages, isLoading } = useChatHistory(pid);
  const sendMsg = useSendChatMessage(pid);
          ...
          <FlatList
            ...
            ListEmptyComponent={
              <View style={styles.empty}>
                <Text style={styles.emptyTitle}>BuildFlow Assistant</Text>
                <Text style={styles.emptyBody}>
                  Ask me about project status, estimates, bills, GST, or overdue tasks.
                </Text>
              </View>
            }
          />
...
const styles = StyleSheet.create({
  ...
  empty: { padding: 32, alignItems: 'center', marginTop: 60 },
  ...
  bubbleBot: { backgroundColor: '#FFFFFF', borderBottomLeftRadius: 4, borderWidth: 1, borderColor: '#E2E8F0' },
