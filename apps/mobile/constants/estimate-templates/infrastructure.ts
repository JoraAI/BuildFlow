    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { itemCode: 'HW-E-003', description: 'Embankment fill with selected soil (compacted)', unit: 'cum', quantity: 6500, rate: 380, type: 'MATERIAL' },
          { itemCode: 'HW-E-004', description: 'Selected soil borrow material', unit: 'cum', quantity: 6800, rate: 180, type: 'MATERIAL', resourceName: 'Red Earth' },
          { itemCode: 'HW-E-005', description: 'Motor grader for leveling', unit: 'day', quantity: 12, rate: 18000, type: 'EQUIPMENT', resourceName: 'Motor Grader' },
          { itemCode: 'HW-E-006', description: 'Vibratory roller 12T for compaction', unit: 'day', quantity: 15, rate: 10000, type: 'EQUIPMENT', resourceName: 'Vibratory Roller 12T' },
          { itemCode: 'HW-E-007', description: 'Water tanker for compaction', unit: 'trip', quantity: 120, rate: 2200, type: 'EQUIPMENT', resourceName: 'Water Tanker 20000 L' },
          { itemCode: 'HW-E-008', description: 'Field density test (sand replacement)', unit: 'nos', quantity: 80, rate: 2500, type: 'SUBCONTRACTOR' },
          { itemCode: 'HW-E-009', description: 'Sub-grade preparation & compaction', unit: 'sqm', quantity: 8500, rate: 85, type: 'LABOUR' },
        ],
      },
      {
        name: '4. Granular Sub-Base (GSB)',
        items: [
          { itemCode: 'HW-G-001', description: 'GSB material supply (200mm thick compacted)', unit: 'cum', quantity: 1700, rate: 1450, type: 'MATERIAL', resourceName: 'GSB (Granular Sub-Base)' },
          { itemCode: 'HW-G-002', description: 'GSB layer spreading & compaction', unit: 'sqm', quantity: 8500, rate: 180, type: 'MATERIAL', rateAnalysisName: 'GSB Layer 200mm' },
          { itemCode: 'HW-G-003', description: 'Motor grader for GSB leveling', unit: 'day', quantity: 6, rate: 18000, type: 'EQUIPMENT', resourceName: 'Motor Grader' },
          { itemCode: 'HW-G-004', description: 'Vibratory roller for GSB compaction', unit: 'day', quantity: 8, rate: 8000, type: 'EQUIPMENT', resourceName: 'Vibratory Roller 10T' },
          { itemCode: 'HW-G-005', description: 'Water tanker for GSB compaction', unit: 'trip', quantity: 35, rate: 2200, type: 'EQUIPMENT', resourceName: 'Water Tanker 20000 L' },
        ],
      },
      {
        name: '5. Wet Mix Macadam (WMM)',
        items: [
          { itemCode: 'HW-W-001', description: 'WMM material supply (250mm thick)', unit: 'cum', quantity: 2125, rate: 2100, type: 'MATERIAL', resourceName: 'WMM (Wet Mix Macadam)' },
          { itemCode: 'HW-W-002', description: 'WMM layer spreading & compaction', unit: 'sqm', quantity: 8500, rate: 280, type: 'MATERIAL', rateAnalysisName: 'WMM Layer 250mm' },
          { itemCode: 'HW-W-003', description: 'WMM plant operation', unit: 'day', quantity: 8, rate: 15000, type: 'EQUIPMENT', resourceName: 'WMM Plant' },
          { itemCode: 'HW-W-004', description: 'Vibratory roller 12T for WMM', unit: 'day', quantity: 10, rate: 10000, type: 'EQUIPMENT', resourceName: 'Vibratory Roller 12T' },
          { itemCode: 'HW-W-005', description: 'Tipper for WMM transport', unit: 'trip', quantity: 180, rate: 1800, type: 'EQUIPMENT', resourceName: 'Tipper / Dumper 10 cum (Local)' },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          { itemCode: 'HW-D-001', description: 'DBM 50mm binder course (supply & lay)', unit: 'sqm', quantity: 8500, rate: 520, type: 'MATERIAL', rateAnalysisName: 'DBM 75mm (Dense Bituminous Macadam)' },
          { itemCode: 'HW-D-002', description: 'Bitumen VG30 for DBM mix', unit: 'ton', quantity: 42, rate: 52000, type: 'MATERIAL', resourceName: 'Bitumen VG30' },
          { itemCode: 'HW-D-003', description: 'Aggregates 20mm for DBM mix', unit: 'cum', quantity: 120, rate: 1400, type: 'MATERIAL', resourceName: '20mm Aggregate' },
          { itemCode: 'HW-D-004', description: 'Aggregates 10mm for DBM mix', unit: 'cum', quantity: 80, rate: 1350, type: 'MATERIAL', resourceName: '10mm Aggregate' },
          { itemCode: 'HW-D-005', description: 'Stone dust filler for DBM', unit: 'cum', quantity: 45, rate: 1200, type: 'MATERIAL', resourceName: 'Stone Dust' },
          { itemCode: 'HW-D-006', description: 'Hot mix plant 90 TPH', unit: 'day', quantity: 6, rate: 25000, type: 'EQUIPMENT', resourceName: 'Hot Mix Plant 60-90 TPH' },
          { itemCode: 'HW-D-007', description: 'Paver finisher', unit: 'day', quantity: 5, rate: 35000, type: 'EQUIPMENT', resourceName: 'Paver Finisher' },
          { itemCode: 'HW-D-008', description: 'Vibratory roller for DBM compaction', unit: 'day', quantity: 6, rate: 8000, type: 'EQUIPMENT', resourceName: 'Vibratory Roller 10T' },
          { itemCode: 'HW-D-009', description: 'Transit mixer for hot mix', unit: 'trip', quantity: 85, rate: 3500, type: 'EQUIPMENT', resourceName: 'Transit Mixer 6 cum' },
        ],
      },
      {
        name: '8. Bituminous Concrete (BC) Wearing Course',
        items: [
          { itemCode: 'HW-B-001', description: 'BC 40mm wearing course (supply & lay)', unit: 'sqm', quantity: 8500, rate: 420, type: 'MATERIAL', rateAnalysisName: 'Bituminous Concrete 40mm' },
          { itemCode: 'HW-B-002', description: 'Bitumen VG30 for BC mix', unit: 'ton', quantity: 38, rate: 52000, type: 'MATERIAL', resourceName: 'Bitumen VG30' },
          { itemCode: 'HW-B-003', description: 'Aggregates 13.2mm for BC', unit: 'cum', quantity: 85, rate: 1450, type: 'MATERIAL', resourceName: '12.5mm Aggregate' },
          { itemCode: 'HW-B-004', description: 'Aggregates 10mm for BC', unit: 'cum', quantity: 55, rate: 1350, type: 'MATERIAL', resourceName: '10mm Aggregate' },
          { itemCode: 'HW-B-005', description: 'Stone dust filler for BC', unit: 'cum', quantity: 30, rate: 1200, type: 'MATERIAL', resourceName: 'Stone Dust' },
          { itemCode: 'HW-B-006', description: 'Hydrated lime filler', unit: 'ton', quantity: 3, rate: 8500, type: 'MATERIAL' },
          { itemCode: 'HW-B-007', description: 'Hot mix plant for BC', unit: 'day', quantity: 5, rate: 25000, type: 'EQUIPMENT', resourceName: 'Hot Mix Plant 60-90 TPH' },
          { itemCode: 'HW-B-008', description: 'Paver finisher for BC', unit: 'day', quantity: 4, rate: 35000, type: 'EQUIPMENT', resourceName: 'Paver Finisher' },
          { itemCode: 'HW-B-009', description: 'Vibratory roller for BC', unit: 'day', quantity: 5, rate: 8000, type: 'EQUIPMENT', resourceName: 'Vibratory Roller 10T' },
        ],
      },
      {
        name: '9. Shoulders & Kerbs',
        items: [
          { itemCode: 'HW-S-001', description: 'Earthen shoulder with gravel', unit: 'cum', quantity: 380, rate: 450, type: 'MATERIAL' },
      ...
      },
      {
        ...
        items: [
          ...
          { itemCode: 'HW-DN-002', description: 'RCC NP3 hume pipe 600mm dia', unit: 'rmt', quantity: 150, rate: 2800, type: 'MATERIAL' },
          ...
          { itemCode: 'HW-DN-006', description: 'Culvert RCC slab (3m span)', unit: 'cum', quantity: 25, rate: 8200, type: 'MATERIAL' },
          { itemCode: 'HW-DN-007', description: 'Culvert wing walls & abutments', unit: 'cum', quantity: 45, rate: 7800, type: 'MATERIAL' },
      ...
      },
      {
        ...
        items: [
          { itemCode: 'HW-RM-001', description: 'Thermoplastic road marking (white, center line)', unit: 'rmt', quantity: 1800, rate: 180, type: 'MATERIAL' },
          { itemCode: 'HW-RM-002', description: 'Thermoplastic road marking (yellow, edge line)', unit: 'rmt', quantity: 3600, rate: 180, type: 'MATERIAL' },
          ...
          { itemCode: 'HW-RM-009', description: 'Road signage boards (directional)', unit: 'nos', quantity: 15, rate: 8500, type: 'MATERIAL' },
      ...
      },
      {
        ...
        items: [
          { itemCode: 'HW-SL-001', description: 'Octagonal steel lighting pole 9m', unit: 'nos', quantity: 40, rate: 35000, type: 'MATERIAL' },
          ...
          { itemCode: 'HW-SL-004', description: 'Underground cable for lighting', unit: 'rmt', quantity: 2000, rate: 280, type: 'MATERIAL' },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { itemCode: 'RP-E-002', description: 'Embankment fill', unit: 'cum', quantity: 5000, rate: 380, type: 'MATERIAL' },
          { itemCode: 'RP-E-003', description: 'Sub-grade compaction', unit: 'sqm', quantity: 8500, rate: 85, type: 'LABOUR' },
          { itemCode: 'RP-E-004', description: 'Vibratory roller for compaction', unit: 'day', quantity: 15, rate: 10000, type: 'EQUIPMENT', resourceName: 'Vibratory Roller 12T' },
        ],
      },
      {
      ...
      },
      {
        ...
        items: [
          ...
          { itemCode: 'RP-JT-003', description: 'Expansion joint filler board', unit: 'sqm', quantity: 85, rate: 280, type: 'MATERIAL' },
          ...
          { itemCode: 'RP-JT-006', description: 'Diamond blade for saw', unit: 'nos', quantity: 8, rate: 4500, type: 'MATERIAL' },
        ],
      },
      {
        ...
        items: [
          ...
          { itemCode: 'RP-CR-004', description: 'Texturing brush for surface', unit: 'nos', quantity: 12, rate: 850, type: 'MATERIAL' },
        ],
      },
      {
        name: '7. Shoulders, Drainage & Miscellaneous',
        items: [
          { itemCode: 'RP-SD-001', description: 'Earthen shoulders with gravel', unit: 'cum', quantity: 380, rate: 450, type: 'MATERIAL' },
          ...
          { itemCode: 'RP-SD-004', description: 'RCC hume pipes 600mm', unit: 'rmt', quantity: 150, rate: 2800, type: 'MATERIAL' },
          { itemCode: 'RP-SD-005', description: 'Road marking (thermoplastic)', unit: 'rmt', quantity: 1800, rate: 180, type: 'MATERIAL' },
          { itemCode: 'RP-SD-006', description: 'Crash barrier (W-beam)', unit: 'rmt', quantity: 500, rate: 1850, type: 'MATERIAL' },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { itemCode: 'CN-E-004', description: 'Excavator 20T for bulk excavation', unit: 'day', quantity: 35, rate: 28000, type: 'EQUIPMENT', resourceName: 'Excavator 20T (PC200)' },
          { itemCode: 'CN-E-005', description: 'Excavator PC130 for trimming', unit: 'day', quantity: 15, rate: 18000, type: 'EQUIPMENT', resourceName: 'Excavator PC130' },
          { itemCode: 'CN-E-006', description: 'Tipper for soil hauling', unit: 'trip', quantity: 850, rate: 1800, type: 'EQUIPMENT', resourceName: 'Tipper / Dumper 10 cum (Local)' },
          { itemCode: 'CN-E-007', description: 'Embankment construction with selected soil', unit: 'cum', quantity: 4500, rate: 380, type: 'MATERIAL' },
          { itemCode: 'CN-E-008', description: 'Vibratory roller for embankment compaction', unit: 'day', quantity: 20, rate: 8000, type: 'EQUIPMENT', resourceName: 'Vibratory Roller 10T' },
          { itemCode: 'CN-E-009', description: 'Water tanker for compaction', unit: 'trip', quantity: 180, rate: 2200, type: 'EQUIPMENT', resourceName: 'Water Tanker 20000 L' },
          { itemCode: 'CN-E-010', description: 'Moorum for embankment', unit: 'cum', quantity: 2500, rate: 650, type: 'MATERIAL', resourceName: 'Moorum (Gravel)' },
        ],
      },
      {
        ...
        items: [
          ...
          { itemCode: 'CN-PL-002', description: 'PCC M15 lining (100mm thick) - sides', unit: 'cum', quantity: 220, rate: 5500, type: 'MATERIAL' },
      ...
      },
      {
        ...
        items: [
          { itemCode: 'CN-RL-001', description: 'RCC M25 lining (150mm thick) with reinforcement', unit: 'cum', quantity: 450, rate: 8500, type: 'MATERIAL' },
      ...
      },
      {
        ...
        items: [
          { itemCode: 'CN-JT-001', description: 'Expansion joints (every 4m)', unit: 'rmt', quantity: 2500, rate: 180, type: 'MATERIAL' },
          { itemCode: 'CN-JT-002', description: 'Joint filler board', unit: 'sqm', quantity: 150, rate: 280, type: 'MATERIAL' },
      ...
      },
      {
        ...
        items: [
          { itemCode: 'CN-OT-001', description: 'RCC outlet structure (turnout)', unit: 'nos', quantity: 8, rate: 45000, type: 'MATERIAL' },
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { itemCode: 'BR-PF-007', description: 'Concrete for piles (M30)', unit: 'cum', quantity: 542, rate: 8500, type: 'MATERIAL' },
      ...
      },
      {
        ...
        items: [
          ...
          { itemCode: 'BR-PC-003', description: 'RCC M30 pile caps', unit: 'cum', quantity: 220, rate: 9500, type: 'MATERIAL' },
      ...
      },
      {
        ...
        items: [
          { itemCode: 'BR-PI-001', description: 'RCC M35 pier columns', unit: 'cum', quantity: 180, rate: 12000, type: 'MATERIAL' },
          { itemCode: 'BR-PI-002', description: 'RCC M35 pier caps', unit: 'cum', quantity: 120, rate: 12500, type: 'MATERIAL' },
          ...
          { itemCode: 'BR-PI-004', description: 'Shuttering for piers (steel)', unit: 'sqm', quantity: 850, rate: 450, type: 'MATERIAL' },
      ...
      },
      {
        ...
        items: [
          ...
          { itemCode: 'BR-SS-006', description: 'Deck slab RCC M35', unit: 'cum', quantity: 150, rate: 12500, type: 'MATERIAL' },
      ...
      },
      {
        ...
        items: [
          ...
          { itemCode: 'BR-EJ-002', description: 'Bituminous wearing coat 75mm', unit: 'sqm', quantity: 750, rate: 850, type: 'MATERIAL' },
      ...
      },
      {
        ...
        items: [
          { itemCode: 'BR-RA-001', description: 'SS crash barrier railings', unit: 'rmt', quantity: 200, rate: 2800, type: 'MATERIAL' },
          ...
          { itemCode: 'BR-RA-003', description: 'RCC footpath slab', unit: 'cum', quantity: 45, rate: 9500, type: 'MATERIAL' },
          { itemCode: 'BR-RA-004', description: 'Approach slab RCC M30', unit: 'cum', quantity: 60, rate: 9500, type: 'MATERIAL' },
          { itemCode: 'BR-RA-005', description: 'Approach embankment fill', unit: 'cum', quantity: 850, rate: 380, type: 'MATERIAL' },
        ],
      },
      {
    ...
    sections: [
      ...
      },
      {
        ...
        items: [
          ...
          { itemCode: 'DR-E-003', description: 'JCB 3DX for excavation', unit: 'day', quantity: 18, rate: 12000, type: 'EQUIPMENT', resourceName: 'JCB Excavator 3DX' },
          ...
          { itemCode: 'DR-E-005', description: 'Timber shoring for deep trenches', unit: 'sqm', quantity: 450, rate: 280, type: 'MATERIAL' },
        ],
      },
      {
        ...
        items: [
          ...
          { itemCode: 'DR-P-002', description: 'RCC NP3 hume pipe 600mm dia', unit: 'rmt', quantity: 850, rate: 2800, type: 'MATERIAL' },
          { itemCode: 'DR-P-003', description: 'RCC NP3 hume pipe 900mm dia', unit: 'rmt', quantity: 150, rate: 5200, type: 'MATERIAL' },
          { itemCode: 'DR-P-004', description: 'HDPE pipe 315mm for cross drains', unit: 'rmt', quantity: 120, rate: 1800, type: 'MATERIAL' },
          { itemCode: 'DR-P-005', description: 'Pipe collar/joint rings', unit: 'nos', quantity: 200, rate: 180, type: 'MATERIAL' },
      ...
      },
      {
        ...
        items: [
          ...
          { itemCode: 'DR-MH-005', description: 'Steps (M.S.) for manholes', unit: 'nos', quantity: 150, rate: 280, type: 'MATERIAL' },
        ],
      },
      {
        name: '5. Backfilling & Restoration',
        items: [
          { itemCode: 'DR-BF-001', description: 'Backfilling with excavated soil', unit: 'cum', quantity: 2200, rate: 180, type: 'MATERIAL' },
          { itemCode: 'DR-BF-002', description: 'Backfilling with sand around pipes', unit: 'cum', quantity: 350, rate: 1700, type: 'MATERIAL', resourceName: 'River Sand (Coarse)' },
          { itemCode: 'DR-BF-003', description: 'Plate compactor for backfill', unit: 'day', quantity: 15, rate: 1200, type: 'EQUIPMENT', resourceName: 'Plate Compactor' },
          { itemCode: 'DR-BF-004', description: 'Road surface restoration (BC)', unit: 'sqm', quantity: 1800, rate: 420, type: 'MATERIAL' },
        ],
      },
      {
        ...
        items: [
          ...
          { itemCode: 'DR-OF-002', description: 'Energy dissipater blocks', unit: 'cum', quantity: 15, rate: 8200, type: 'MATERIAL' },
          { itemCode: 'DR-OF-003', description: 'Stone pitching for outfall', unit: 'sqm', quantity: 280, rate: 850, type: 'MATERIAL' },
        ],
      },
    ],
  },
